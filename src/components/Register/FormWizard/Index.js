...
import {RegisterContext} from "../../../Context/RegisterContext"
 ...
 function   Index() {
  ...
  const {currentTab,setCurrentTab,nextStep, prevStep, handleSelect}= context


  return (

    <Tab.Container defaultActiveKey={currentTab.key} onSelect={handleSelect} id="controlled-tab">
                      ...
                      <Nav className="m-0">
                        <ul className="nav stepnav nav-fill flex-column contrls" id="myTab" role="tablist">
                          ...
                          <li className="nav-item">
                            <Link className="nav-link redial-pin redial-relative px-0 rounded" data-toggle="tab" href="#left4" role="tab" aria-controls="left4" aria-expanded="true"> 
                          ...
                          <Nav.Item>
                            <Nav.Link eventKey={2}>
                          <li className="nav-item">
                            <Link className="nav-link redial-pin redial-relative px-0 rounded" data-toggle="tab" href="#left2" role="tab" aria-controls="left2" aria-expanded="true"> 
                              <div className="media text-left pl-3">
                          ...
                          <Nav.Item>
                            <Nav.Link eventKey={3}>
                          <li className="nav-item">
                            <Link className="nav-link redial-dark redial-relative px-0 rounded" data-toggle="tab" href="#left1" role="tab" aria-controls="left1" aria-expanded="true"> 
                              <div className="media text-left pl-3">
                          ...
                          <ul className="pager wizard">
                            <li className="previous" onClick={prevStep}></li>
                            <li className="next" onClick={nextStep} ></li>
                          </ul>
                        </ul>
                        </Nav>
                        </div>
